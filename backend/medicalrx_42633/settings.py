"""
Django settings for medicalrx_42633 project.
...
ROOT_URLCONF = 'medicalrx_42633.urls'
...
WSGI_APPLICATION = 'medicalrx_42633.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "medicalrx_42633 API",
    "DESCRIPTION": "API documentation for medicalrx_42633 App",
    "VERSION": "v1",
}
